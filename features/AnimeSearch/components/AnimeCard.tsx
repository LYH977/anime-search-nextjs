...
export const AnimeCard = ({ title, id, imageUrl }: AnimeCardProps) => {
    ...
    return (
        <Link href={ `/anime/${id}` } className='shadow-lg shadow-[#2e3d0d] pb-4 w-[200px] h-[400px] rounded-lg overflow-hidden cursor-pointer ' tabIndex={ 0 } title={ title } aria-labelledby={ animeId }>
